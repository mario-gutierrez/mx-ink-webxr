...
This application uses Three.js and WebXR to provide an immersive 3D painting experience using Logitech MX-INK, featuring a virtual whiteboard and free in-air drawing.
